...
const VideoInfo = () => {
    return (
        <>
            <h2 className='text-3xl font-semibold'>Lorem Ipsum is simply dummy text of the printing.</h2>
            <div className='flex gap-8 items-center my-4'>
                ...
                <div className='flex gap-2 items-center w-[150px] h-[2px] bg-[#DBDBDB] rounded-full'>
                    <span className={`bg-[#0A2A8D] w-[110px] h-[3px] rounded-full`}></span>
                </div>
            ...
            <div className='flex items-center gap-3 mb-8'>
                <div className='flex items-center justify-center w-[40px] h-[40px] bg-[#D9D9D9] rounded-full'>
                    <span className='text-[#8B8B8B] font-semibold text-[18px]'>M</span>
                </div>
