  ...
  return (
    <>
      ...
      <div className="flex gap-5 mt-7">
        <div className="w-[250px] h-auto rounded-xl bg-[#F2F2F2] py-5 px-4">
          <h4 className="font-semibold text-xl text-[#232323]">Language</h4>
          <p className="text-md text-[#232323]">English</p>
          <h4 className="font-semibold text-xl text-[#232323] mt-5">Skills</h4>
        ...
        <div className="flex-1">
          ...
          <div className="bg-[#F2F2F2] py-8 px-5 rounded-xl mt-6">
