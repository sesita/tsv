                ...
                <div className="flex-1">
                    <div className="flex items-center justify-between gap-5 px-8 mb-6">
                        <div className="text-center">
                            <h2 className="text-6xl font-bold text-[#C60C0D]">{currentUser.following}</h2>
                            <p className="text-md text-[#232323]">Following</p>
                        </div>
                        <div className="text-center">
                            <h2 className="text-6xl font-bold text-[#C60C0D]">{currentUser.followers}</h2>
                            <p className="text-md text-[#232323]">Followers</p>
                        </div>
                        <div className="text-center">
                            <h2 className="text-6xl font-bold text-[#C60C0D]">{currentUser.views}</h2>
