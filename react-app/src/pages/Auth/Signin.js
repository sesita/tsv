                    ...
                    <div className="bg-white md:rounded-3xl rounded-xl flex justify-between max-h-[700px]">
                        <div className="mx-auto my-auto py-5 md:px-7 px-2">
                            <div className="flex flex-col gap-6">
                                ...
                                <p className="text-center">or use your email for login:</p>
                        ...
                        <div className="md:w-5/12 w-3/12">
                            <img src={require("../../assets/img/Login.png")} alt="" className="w-full h-full object-cover md:rounded-r-3xl rounded-r-xl" />
                        </div>
                    </div>
                </div>
            </section>
