...
const Signup = () => {
    ...
    const handleSignup = (e) => {
        ...
        if (!channelName || !name || !email || !password || !phoneNumber || channelName === "" || name === "" || email === "" || password === "" || phoneNumber === "") {
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <form className="flex flex-col gap-3 md:w-[400px] w-full" method="post" onSubmit={(e) => handleSignup(e)}>
                                    ...
                                    <div className="flex gap-3 md:flex-row flex-col">
                                        ...
                                        <input type="number" className="rounded-full border-[1px] border-[#0A2A8D52] bg-[#E3EAFF52] outline-none py-3 md:px-4 px-2 md:text-md text-xs w-full" placeholder="Phone Number" name="phoneNumber" />
                                    </div>
                                    <div className="flex gap-1">
                                        <input type="checkbox" name="checkbox" id="checkbox" />
                                        <label htmlFor="checkbox" className="md:text-md text-xs">
                                            I agree to Terms and <span className="text-[#C60C0D]">Privacy.</span>
                                        </label>
                                    </div>
